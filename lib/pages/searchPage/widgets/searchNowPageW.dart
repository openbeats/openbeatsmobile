  ...
  return Container(
    child: IconButton(
      ...
      onPressed: () {
        ...
        setCurrSearchString(queryFieldController.text);
        // going back to previous screen with the suggestion data
...
Widget suggestionsListTile(BuildContext context, int index, bool showHistory,
  ...
  return ListTile(
    title: Container(
      ...
      child: Text(
        (showHistory) ? searchHistory[index] : suggestionResponseList[index][0],
        style: TextStyle(
          color: Colors.grey,
        ),
        maxLines: 2,
    ...
    onTap: () {
      // setting global variable to persist search
      setCurrSearchString((showHistory)
          ? searchHistory[index]
